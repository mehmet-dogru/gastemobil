...
const createValidation = Joi.object({
  full_name: Joi.string().required().min(3).messages({
    "string.base": `Ad Soyad alanı String bir değer olmalıdır!`,
    "string.empty": `Ad Soyad alanı boş bırakılamaz!`,
    "string.min": `Ad Soyad en az {#limit} karakter olmalı!`,
    "any.required": `Ad Soyad alanı boş bırakılamaz!`,
  }),
  username: Joi.string().required().min(3).messages({
    "string.base": `Kullanıcı adı alanı String bir değer olmalıdır!`,
    "string.empty": `Kullanıcı adı alanı boş bırakılamaz!`,
    "string.min": `Kullanıcı adı en az {#limit} karakter olmalı!`,
